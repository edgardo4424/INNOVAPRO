...
const obtenerUbigeoDireccion = require("../../application/useCases/obtenerUbigeoDireccion");

const sequelizeUbigeoRepository = require("../../../ubigeo/infrastructure/repository/sequelizeUbigeoRepository");

const ubigeoRepo = new sequelizeUbigeoRepository();
...
const LocalizacionController = {
    ...
    obtenerUbigeo: async (req, res) => {
        try {
            ...
            const { codigo, respuesta } = await obtenerUbigeoDireccion(direccion.trim(),ubigeoRepo);
