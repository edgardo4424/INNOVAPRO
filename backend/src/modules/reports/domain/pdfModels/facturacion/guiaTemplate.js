...
const { pdfProductosGuia } = require("../../components/facturacion/pdfProductosGuia");
const { pdfObservacionesGuia } = require("../../components/facturacion/pdfObservacionesGuia");
const { pdfDatosGuia } = require("../../components/facturacion/pdfDatosGuia");
const { pdfDatosGuiaHeader } = require("../../components/facturacion/pdfDatosGuiaHeader");
