module.exports = async (id, dataMantenimientoRepository) => {
    const dataMantenimiento = await dataMantenimientoRepository.obtenerPorId(id); // Llama al método del repositorio para obtener un dataMantenimiento por ID
