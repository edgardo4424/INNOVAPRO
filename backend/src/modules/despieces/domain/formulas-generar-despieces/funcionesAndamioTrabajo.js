...
function calcularHusilloDeNivelacion({ longitud, cantidadAndamios, tipoApoyo }) {
...
function calcularGarruchaConFreno({ longitud, cantidadAndamios, tipoApoyo }) {
...
function calcularPiezaInicio(valor1, valor2) {
    return valor1 + valor2;
  }

// 4. Pieza: AM.0600 - VERTICAL 3.00m
function calcularVertical300() {
  return 0;
}

// 5. Pieza: AM.0700 - VERTICAL 2.00m
function calcularVertical200({ longitud, cantidadAndamios, altura }) {
    const esPar = (x) => x % 2 === 0;
...
function calcularVertical100({ longitud, cantidadAndamios, altura, ancho, cantPlataforma }) {
    const esPar = x => x % 2 === 0;
...
function calcularEspiga(valorCalcularVertical200, valorCalcularVertical150, valorCalcularVertical100, valorCalcularVertical050, valorCalcularMensula1090, valorCalcularMensula700, valorCalcularMensula300, valorCalcularAcopladorMulti) {
...
function calcularHorizontalMulti3072({ datosHorizontalMulti3072=3072, longitud, ancho, altura, plataformaAcceso, cantPlataforma, cantidadAndamios }) {
    const esPar = x => x % 2 === 0;
    let total = 0;
...
function calcularHorizontalMulti2572({ datosHorizontalMulti2572=2572, longitud, ancho, altura, cantPlataforma, plataformaAcceso, cantidadAndamios }) {
    const esPar = x => x % 2 === 0;
    let total = 0;
...
function calcularHorizontalMulti2072({ datosHorizontalMulti2072=2072, longitud, ancho, altura, cantPlataforma, plataformaAcceso, cantidadAndamios }) {
...
function calcularHorizontalMulti1572({ datosHorizontalMulti1572=1572, longitud, ancho, altura, cantPlataforma, plataformaAcceso, cantidadAndamios }) {
    const esPar = x => x % 2 === 0;
    let total = 0;
...
function calcularHorizontalMulti1090({ datosHorizontalMulti1090=1090, longitud, ancho, altura, cantPlataforma, plataformaAcceso, cantidadAndamios }) {
    const esPar = x => x % 2 === 0;
  let total = 0;
...
function calcularHorizontalMulti1020() { return 0; }

// 16. Pieza: AM.2000 - HORIZONTAL MULTI DE 0732mm
function calcularHorizontalMulti0732({ datosHorizontalMulti0732=732, longitud, ancho, altura, cantPlataforma, plataformaAcceso, cantidadAndamios }) {
    const esPar = x => x % 2 === 0;
    let total = 0;
...
function calcularHorizontalMulti0432MensulaN() { return 0; }

// 18. Pieza: AM.2050 - HORIZONTAL MULTI DE 0432mm PARA MENSULA - E
function calcularHorizontalMulti0432MensulaE() { return 0; }

// 19. Pieza: AM.2800 - BARANDILLAS COMBI 3072mm
function calcularBarandillaCombi3072() { return 0; }

// 20. Pieza: AM.2900 - BARANDILLAS COMBI 2072mm
function calcularBarandillaCombi2072() { return 0; }

// 21. Pieza: AM.3000 - BARANDILLAS COMBI 0732mm 
function calcularBarandillaCombi0732() { return 0; }

// 22. Pieza: AM.3100 - MENSULA 1090mm
function calcularMensula1090() { return 0; }

// 23. Pieza: AM.3200 - MENSULA 700mm
function calcularMensula700() { return 0; }

// 24. Pieza: AM.3300 - MENSULA 300mm
function calcularMensula300() { return 0; }

// 25. Pieza: AM.3400 - RODAPIE 3072mm - E
function calcularRodapie3072E() { return 0; }

// 26. Pieza: AM.3500 - RODAPIE 2572mm - E
function calcularRodapie2572E() { return 0; }

// 27. Pieza: AM.3600 - RODAPIE 2072mm - E
function calcularRodapie2072E() { return 0; }

// 28. Pieza: AM.3700 - RODAPIE 1020mm - E
function calcularRodapie1020E() { return 0; }

// 29. Pieza: AM.3800 - RODAPIE 0732mm - E
function calcularRodapie0732E() { return 0; }

// 30. Pieza: AM.3900 - RODAPIE 3072mm - C
function calcularRodapie3072C({ longitud, ancho, altura, cantPlataforma, tipoRodapie, cantidadAndamios, datosRodapie3072C=3072 }) {
    const esPar = x => x % 2 === 0;
    let total = 0;
...
function calcularRodapie2572C({ longitud, ancho, altura, cantPlataforma, tipoRodapie, cantidadAndamios, datosRodapie2572C=2572 }) {
    const esPar = x => x % 2 === 0;
    let total = 0;
...
function calcularRodapie2072C({ longitud, ancho, altura, cantPlataforma, tipoRodapie, cantidadAndamios, datosRodapie2072C=2072 }) {
    const esPar = x => x % 2 === 0;
    let total = 0;
...
function calcularRodapie1572C({ longitud, ancho, altura, cantPlataforma, tipoRodapie, cantidadAndamios, datosRodapie1572C=1572 }) {
    const esPar = x => x % 2 === 0;
    let total = 0;
...
function calcularRodapie1090C({ longitud, ancho, altura, cantPlataforma, tipoRodapie, cantidadAndamios, datosRodapie1090C=1090 }) {
    const esPar = x => x % 2 === 0;
    let total = 0;
...
function calcularRodapie0732C({ longitud, ancho, altura, cantPlataforma, tipoRodapie, cantidadAndamios, datosRodapie0732C=732 }) {
    const esPar = x => x % 2 === 0;
    let total = 0;
...
function calcularRodapie3072N({ longitud, ancho, altura, cantPlataforma, tipoRodapie, cantidadAndamios, datosRodapie3072N=3072 }) {
    const esPar = x => x % 2 === 0;
    let total = 0;
...
function calcularRodapie2572N({ longitud, ancho, altura, cantPlataforma, tipoRodapie, cantidadAndamios, datosRodapie2572N=2572 }) {
    const esPar = x => x % 2 === 0;
    let total = 0;
...
function calcularRodapie2072N({ longitud, ancho, altura, cantPlataforma, tipoRodapie, cantidadAndamios, datosRodapie2072N=2072 }) {
    const esPar = x => x % 2 === 0;
    let total = 0;
...
function calcularRodapie1572N({ longitud, ancho, altura, cantPlataforma, tipoRodapie, cantidadAndamios, datosRodapie1572N=1572 }) {
    const esPar = x => x % 2 === 0;
    let total = 0;
...
function calcularRodapie1090N({ longitud, ancho, altura, cantPlataforma, tipoRodapie, cantidadAndamios, datosRodapie1090N=1090 }) {
    const esPar = x => x % 2 === 0;
    let total = 0;
...
function calcularRodapie0732N({ longitud, ancho, altura, cantPlataforma, tipoRodapie, cantidadAndamios, datosRodapie0732N=732 }) {
    const esPar = x => x % 2 === 0;
    let total = 0;
...
function calcularDiagonal3072({ longitud, ancho, altura, cantidadAndamios, datosDiagonal3072=3072 }) {
    const esPar = x => x % 2 === 0;
    let total = 0;
...
function calcularDiagonal2572({ longitud, ancho, altura, cantidadAndamios, datosDiagonal2572=2572 }) {
    const esPar = x => x % 2 === 0;
    let total = 0;
...
function calcularDiagonal2072({ longitud, ancho, altura, cantidadAndamios, datosDiagonal2072=2072 }) {
    const esPar = x => x % 2 === 0;
    let total = 0;
...
function calcularDiagonal1572({ longitud, ancho, altura, cantidadAndamios, datosDiagonal1572=1572 }) {
    const esPar = x => x % 2 === 0;
    let total = 0;
...
function calcularDiagonal1090({ longitud, ancho, altura, cantidadAndamios, datosDiagonal1090=1090 }) {
    const esPar = x => x % 2 === 0;
    let total = 0;
...
function calcularDiagonal1020({ longitud, ancho, altura, cantidadAndamios, datosDiagonal1020=1020 }) {
    const esPar = x => x % 2 === 0;
    let total = 0;
...
function calcularPlataformaMetalica290x3072E({ longitud, tipoPlataforma, plataformaAcceso, cantPlataforma, altura, ancho, datosPlataformaMetalica290x3072E=3072 }) {
    const esPar = x => x % 2 === 0;
...
function calcularPlataformaMetalica290x2572E({ longitud, tipoPlataforma, plataformaAcceso, cantPlataforma, altura, ancho, datosPlataformaMetalica290x2572E=2572 }) {
    const esPar = x => x % 2 === 0;
...
function calcularPlataformaMetalica290x2072E({ longitud, tipoPlataforma, plataformaAcceso, cantPlataforma, altura, ancho, datosPlataformaMetalica290x2072E=2072 }) {
    const esPar = x => x % 2 === 0;
...
function calcularPlataformaMetalica290x1572E({ longitud, tipoPlataforma, plataformaAcceso, cantPlataforma, altura, ancho, datosPlataformaMetalica290x1572E=1572 }) {
    const esPar = x => x % 2 === 0;
...
function calcularPlataformaMetalica290x1020E({ longitud, tipoPlataforma, plataformaAcceso, cantPlataforma, altura, ancho, datosPlataformaMetalica290x1020E=1020 }) {
    const esPar = x => x % 2 === 0;
...
function calcularPlataformaMetalica290x0732E({ longitud, tipoPlataforma, plataformaAcceso, cantPlataforma, altura, ancho, datosPlataformaMetalica290x0732E=732 }) {
    const esPar = x => x % 2 === 0;
...
function calcularPlataformaMetalica320x3072C({ longitud, tipoPlataforma, plataformaAcceso, cantPlataforma, altura, ancho, datosPlataformaMetalica320x3072C=3072 }) {
    const esPar = x => x % 2 === 0;
...
function calcularPlataformaMetalica320x2572C({ longitud, tipoPlataforma, plataformaAcceso, cantPlataforma, altura, ancho, datosPlataformaMetalica320x2572C=2572 }) {
    const esPar = x => x % 2 === 0;
...
function calcularPlataformaMetalica320x2072C({ longitud, tipoPlataforma, plataformaAcceso, cantPlataforma, altura, ancho, datosPlataformaMetalica320x2072C=2072 }) {
    const esPar = x => x % 2 === 0;
...
function calcularPlataformaMetalica320x1572C({ longitud, tipoPlataforma, plataformaAcceso, cantPlataforma, altura, ancho, datosPlataformaMetalica320x1572C=1572 }) {
    const esPar = x => x % 2 === 0;
...
function calcularPlataformaMetalica320x1090C({ longitud, tipoPlataforma, plataformaAcceso, cantPlataforma, altura, ancho, datosPlataformaMetalica320x1090C=1090 }) {
    const esPar = x => x % 2 === 0;
...
function calcularPlataformaMetalica320x0732C({ longitud, tipoPlataforma, plataformaAcceso, cantPlataforma, altura, ancho, datosPlataformaMetalica320x0732C=732 }) {
    const esPar = x => x % 2 === 0;
...
function calcularPlataformaMetalica190x3072C({ longitud, tipoPlataforma, cantPlataforma, altura, ancho, datosPlataformaMetalica190x3072C=3072 }) {
    const esPar = x => x % 2 === 0;
    let total = 0;
...
function calcularPlataformaMetalica190x2572C({ longitud, tipoPlataforma, cantPlataforma, altura, ancho, datosPlataformaMetalica190x2572C=2572 }) {
    const esPar = x => x % 2 === 0;
    let total = 0;
...
function calcularPlataformaMetalica190x2072C({ longitud, tipoPlataforma, cantPlataforma, altura, ancho, datosPlataformaMetalica190x2072C=2072 }) {
    const esPar = x => x % 2 === 0;
    let total = 0;
...
function calcularPlataformaMetalica190x1572C({ longitud, tipoPlataforma, cantPlataforma, altura, ancho, datosPlataformaMetalica190x1572C=1572 }) {
    const esPar = x => x % 2 === 0;
    let total = 0;
...
function calcularPlataformaMetalica190x1090C({ longitud, tipoPlataforma, cantPlataforma, altura, ancho, datosPlataformaMetalica190x1090C=1090 }) {
    const esPar = x => x % 2 === 0;
    let total = 0;
...
function calcularPlataformaMetalica190x1020C({ longitud, tipoPlataforma, cantPlataforma, altura, ancho, datosPlataformaMetalica190x1020C=1020 }) {
    const esPar = x => x % 2 === 0;
    let total = 0;
...
function calcularPlataformaMetalica190x0732C({ longitud, tipoPlataforma, cantPlataforma, altura, ancho, datosPlataformaMetalica190x0732C=732 }) {
    const esPar = x => x % 2 === 0;
    let total = 0;
...
function calcularPlataformaAluminioAcceso3072({ plataformaAcceso, longitud, altura, datosPlataformaAluminioAcceso3072=3072 }) {
    const esPar = x => x % 2 === 0;
...
function calcularPlataformaAluminioAcceso2572({ plataformaAcceso, longitud, altura, datosPlataformaAluminioAcceso2572=2572 }) {
    const esPar = x => x % 2 === 0;
...
function calcularPlataformaAluminioAcceso2072({ plataformaAcceso, longitud, altura, datosPlataformaAluminioAcceso2072=2072 }) {
    const esPar = x => x % 2 === 0;
...
function calcularPlataformaAluminioAcceso1572({ plataformaAcceso, longitud, altura, datosPlataformaAluminioAcceso1572=1572 }) {
    const esPar = x => x % 2 === 0;
...
function calcularPlataformaMixtaAcceso3072() { return 0; }

// 72. Pieza: AM.8000 - PLATAFORMA MIXTA CON ACCESO DE 2572mm
function calcularPlataformaMixtaAcceso2572() { return 0; }

// 73. Pieza: AM.8500 - TUBO CON GANCHO 1.00m
function calcularTuboGancho100({ tuboAmarre, longitud, cantidadAndamios, altura, datosTuboGancho100=1.0 }) {
...
function calcularTuboGancho050({ tuboAmarre, longitud, cantidadAndamios, altura, datosTuboGancho050=0.5 }) {
...
function calcularBridaGiratoria(valorCalcularTuboGancho100, valorCalcularTuboGancho050) {
...
function calcularAcopladorMulti({ ancho, cantPlataforma, longitud, cantidadAndamios, altura }) {
    const esPar = x => x % 2 === 0;
...
function calcularPinGravedad12mm() { return 0; }

// 80. Pieza: AM.9300 - PIN GRAVEDAD 9mm 
function calcularPinGravedad9mm({ paraIzaje, altura, longitud, cantidadAndamios, ancho, cantPlataforma }) {
    const esPar = x => x % 2 === 0;
    let total = 0;
