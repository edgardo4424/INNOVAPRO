class Despiece { 
    constructor({
        ...
        this.cp = cp;
        this.detalles_opcionales = detalles_opcionales;
    }
 ...
 */
        if (modo === "editar") {
            const tieneAlMenosUnCampoValido = ["subtotal", "porcentaje_descuento", "subtotal_con_descuento", "igv_porcentaje", "igv_monto", "total_final", "cp", "detalles_opcionales"].some(
                (campo) => 
