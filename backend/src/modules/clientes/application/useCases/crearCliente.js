module.exports = async (clienteData, clienteRepository, entidadService) => {
    const errorCampos = entidadService.validarCamposObligatorios(clienteData, 'crear')
    ...
    const nuevoClienteData = entidadService.construirEntidadData(clienteData) // Almacenamos los datos del cliente a crear
