...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    await queryInterface.createTable("cierres_planilla_quincenal", {
      id: {
    ...
    // --- planilla_quincenal ---
    await queryInterface.createTable("planilla_quincenal", {
      id: {
        type: Sequelize.INTEGER,
        autoIncrement: true,
        primaryKey: true,
  ...
  async down(queryInterface, Sequelize) {
    // Después de createTable('cierres_planilla_quincenal')
    await queryInterface.addConstraint("cierres_planilla_quincenal", {
      fields: ["filial_id", "periodo"],
      type: "unique",
      name: "uq_cierre_planilla_quincenal",
    ...
    // Después de createTable('planilla_quincenal')
    await queryInterface.addConstraint("planilla_quincenal", {
      fields: [
        "trabajador_id",
        "periodo",
