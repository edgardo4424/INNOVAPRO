...
const ArrayPedidos = [
  // --- EJEMPLOS: POR CONFIRMAR ---
  {
    ...
    tarifario: "Basico",
    plan_Tarifario: "Plan INTERMEDIO",
  ...
  // --- EJEMPLOS: PRE CONFIRMADO ---
  {
    id_pedido: 52,
    filial: "INNOVA RENTAL MAQUINARIA S.A.C.",
    ruc_filial: "20603021933",
    nro_Pedido: "PED-00101",
  ...
  // --- EJEMPLOS: CONFIRMADO ---
  {
    ...
    cliente_Tipo_Doc: "6",
    cliente_Num_Doc: "20602860338",
    cliente_Razon_Social: "Soluciones Zigma S.A.C.",
