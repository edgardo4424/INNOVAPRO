...
const TablePlanillaMensual = ({ planillaMensualTipoPlanilla, total }) => {


  console.log('planillaMensualTipoPlanilla', planillaMensualTipoPlanilla);
          ...
          {/* <TableCaption>A list of your recent invoices.</TableCaption> */}
           ...
           <TableHeader>
            <TableRow className={"bg-gray-800 text-xs "}>
              ...
              <TableHead rowSpan={2} className="text-center border-r text-white border-black">Dias Labor</TableHead>
              ...
              <TableHead rowSpan={2} className="text-center border-r text-white border-black">Descanso Méd</TableHead>

              <TableHead rowSpan={2} className="text-center border-r text-white border-black">Lic. con Goce de Haber</TableHead>
              <TableHead rowSpan={2} className="text-center border-r text-white border-black">Lic. sin Goce de Haber</TableHead>
              <TableHead rowSpan={2} className="text-center border-r text-white border-black">Vacaciones</TableHead>
              <TableHead rowSpan={2} className="text-center border-r text-white border-black">Gratificación</TableHead>
              <TableHead rowSpan={2} className="text-center border-r text-white border-black">CTS</TableHead>
              ...
              <TableHead colSpan={2} className="text-center border-r h-5 text-white border-black">Importe Tardanzas</TableHead>

              <TableHead colSpan={2} className="text-center border-r h-5 text-white border-black">Prom. Bonos</TableHead>
              ...
              <TableHead rowSpan={2} className="text-center border-r text-white border-black">Adelanto / Préstamo</TableHead>

              <TableHead rowSpan={2} className="text-center border-r text-white border-black">Saldo por Pagar</TableHead>
              <TableHead rowSpan={2} className="text-center border-r text-white border-black">ESSALUD 9%</TableHead>

               <TableHead colSpan={3} className="text-center border-r h-5 text-white border-black">APORTES AL TRABAJADOR</TableHead>
            ...
            <TableRow className={"bg-gray-800 text-xs "}>
              ...
              <TableHead rowSpan={2} className="text-center border-r text-white border-black">Seguro Vida Ley %</TableHead>
              <TableHead rowSpan={2} className="text-center border-r text-white border-black">SCTR Salud %</TableHead>
              <TableHead rowSpan={2} className="text-center border-r text-white border-black">SCTR Pension %</TableHead>
            </TableRow>
          ...
          <TableBody>
            ...
            {planillaMensualTipoPlanilla.length > 0 && (
              <>
                 ...
                 {filtrarTrabajadores(planillaMensualTipoPlanilla).map((e, index) => (
                  <RowPlanillaMensual key={index} e={e} index={index} />
                ))}
                {/* <RowTotalPlanillaMensual total={total} /> */}
              </>
            )}
