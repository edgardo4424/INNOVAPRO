...
const RowTotalPlanillaMensual = ({ datosTotalesPlanilla: d }) => {
   return (
      <tfoot className="sticky bottom-0 bg-innova-blue  text-white font-semibold z-20 "> 
         ...
         <TableCell className="text-right pb-4 bg-green-600 ">{d.sumatoria_sueldo_mensual??0}</TableCell>
         <TableCell className="text-right pb-4" colSpan={16}></TableCell>
         <TableCell className="text-right pb-4 bg-green-600 ">{d.sumatoria_sueldo_mensual}</TableCell>
