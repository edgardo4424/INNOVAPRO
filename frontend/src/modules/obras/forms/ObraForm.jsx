            ...
            >
               ...
               <div className="form-group">
                  ...
                  <Input
                     ...
                     onChange={(e) =>
                        setObraInterna({ ...obra, direccion: e.target.value })
                     }
               ...
               <div className="form-group">
                  ...
                  >
                     ...
                     <SelectContent>
                        <SelectItem value="Planificación">
                           Planificación
                        </SelectItem>
                        <SelectItem value="Demolición">Demolición</SelectItem>
                        <SelectItem value="Cimentación y estructura">
               ...
               {isLoaded && obra.latitud && obra.longitud && (
                  <div className="map-container">
                     ...
                     >
                        <Marker
                           position={{ lat: obra.latitud, lng: obra.longitud }}
                        />
                     </GoogleMap>
                  </div>
               )}
