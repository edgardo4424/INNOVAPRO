...
export async function generarCuerpoPlanBasico(doc, data, startY = 120) {
  ...
  // 💬 Capacitación
  const textoCapacitacion = `Capacitación de armado de andamio en obra: S/250 + IGV.`;
  currentY = drawJustifiedText(doc, textoCapacitacion, indent + 3, currentY + 3, 170, 5.5, 10);

  // 🟡 Advertencia
  const observacion = "*Precio sujeto a variación, en caso de que las condiciones en campo no sean las adecuadas para la instalación regular. Esto debe ser confirmado con una visita técnica.*";
  currentY = drawJustifiedText(doc, observacion, indent + 3, currentY + 5, 170, 5, 9);
