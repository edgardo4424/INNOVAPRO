...
export async function renderNotas(doc, data, currentY) {
  ...
  const condiciones = data.condiciones || [
    ...
    `7° Esta cotización NO incluye la instalación de las escuadras. En caso de que el Cliente requiera que ${data.filial?.razon_social} realice la instalación de las escuadras, se debe considerar los siguientes requerimientos previos a la instalación de estas: 
