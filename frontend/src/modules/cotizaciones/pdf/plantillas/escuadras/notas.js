...
export async function renderNotas(doc, data, currentY) {
  ...
  const condiciones = data.condiciones || [
    ...
    `7° Una vez el Cliente devuelva los equipos a nuestros almacenes, ${data.filial?.razon_social}. no cobrará la limpieza, reparación o mantenimiento de estos. No incluye reparaciones por ausencia de algún componente del equipo, daños irreversibles que exija cambio al haberse afectado propiedades geométricas, físicas o mecánicas de este.`,
