                     ...
                     {datos.map((registro, index) => (
                        ...
                        >
                           ...
                           <TableCell className="font-medium">
                              {registro.trabajadores.nombres}{" "}
                              {registro.trabajadores.apellidos}
                           </TableCell>
                           <TableCell>
                              {registro.trabajadores.tipo_documento}
                           </TableCell>
                           <TableCell>
                              {registro.trabajadores.numero_documento}
                           </TableCell>
                           ...
                           <TableCell className="font-medium">
                              {formatearMoneda(registro.sueldo_base)}
                           </TableCell>
                           <TableCell>
                              {formatearMoneda(registro.asignacion_familiar)}
                           </TableCell>
                           <TableCell>
                              {formatearMoneda(registro.promedio_horas_extras)}
                           </TableCell>
                           <TableCell>
                              {formatearMoneda(registro.promedio_bono_obra)}
                           </TableCell>
                           <TableCell className="font-semibold text-primary">
                              {formatearMoneda(
                                 registro.remuneracion_computable
                              )}
                           </TableCell>
                           <TableCell>
                              {formatearMoneda(registro.ultima_gratificacion)}
                           </TableCell>
                           <TableCell>
                              {formatearMoneda(registro.sexto_gratificacion)}
                           </TableCell>
                           ...
                           <TableCell>
                              {formatearMoneda(registro.faltas_importe)}
                           </TableCell>
                           <TableCell>
                              {formatearMoneda(registro.no_computable)}
                           </TableCell>
                           ...
                           <TableCell className="text-sm text-muted-foreground">
                              {formatearFecha(registro.locked_at)}
                           </TableCell>
                        </TableRow>
                     ))}
                  </TableBody>
