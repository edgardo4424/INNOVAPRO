    ...
    return (
        <div className="min-h-screen w-full flex flex-col items-center  md:px-8 py-6 bg-gray-100">
            <div className="w-full max-w-7xl">
                ...
                <div className="bg-white  rounded-lg shadow-md relative flex flex-col">
                    ...
                    <div className="bg-gray-50 border border-gray-200 py-2 text-sm  rounded-md mt-6 text-center text-gray-400">

                        {tipoGuia === 'transporte-privado' ? <GuiaPrivado /> : <GuiaPublico />}
                    </div>
