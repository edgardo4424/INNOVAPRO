...
const ArrayFormasDePago = [
    ...
    { value: "008", act: false, description: "008 - Efectivo (cuando no existe obligación de usar medio de pago)." },
    { value: "009", act: false, description: "009 - Efectivo (en los demás casos)." },
    { value: "010", act: false, description: "010 - Medios de pago usados en comercio exterior." },
    { value: "011", act: false, description: "011 - Documentos emitidos por EDPYMES y cooperativas no autorizadas a captar depósitos." },
    { value: "012", act: false, description: "012 - Tarjeta de crédito (país o exterior) emitida por empresa no perteneciente al sistema financiero." },
    { value: "013", act: false, description: "013 - Tarjetas de crédito emitidas en el exterior por bancos o financieras no domiciliadas." },
    { value: "101", act: false, description: "101 - Transferencias – comercio exterior." },
    { value: "102", act: false, description: "102 - Cheques bancarios – comercio exterior." },
    { value: "103", act: false, description: "103 - Orden de pago simple – comercio exterior." },
    { value: "104", act: false, description: "104 - Orden de pago documentario – comercio exterior." },
    { value: "105", act: false, description: "105 - Remesa simple – comercio exterior." },
    { value: "106", act: false, description: "106 - Remesa documentaria – comercio exterior." },
    { value: "107", act: false, description: "107 - Carta de crédito simple – comercio exterior." },
    { value: "108", act: false, description: "108 - Carta de crédito documentario – comercio exterior." },
    { value: "999", act: false, description: "999 - Otros medios de pago." },
];
