...
const FacturasEmitidas = () => {
    ...
    return (
        <div className="p-5 font-sans bg-gray-50 min-h-screen">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5 mb-8 p-6 bg-white rounded-xl shadow-md items-end">
                ...
                <table className="min-w-full bg-white rounded-xl shadow-md overflow-hidden">
                    <thead className="bg-blue-600 text-white">
                        <tr>
                            ...
                            <th className="py-4 px-6 text-left text-sm font-semibold uppercase tracking-wider">Monto Total</th>
                            <th className="py-4 px-6 text-left text-sm font-semibold uppercase tracking-wider">Estado SUNAT</th>
                        </tr>
                    </thead>
                    <tbody>
                        {facturas.length > 0 ? (
