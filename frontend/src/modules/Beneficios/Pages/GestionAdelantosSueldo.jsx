            ...
            <table className="w-full text-left">
              <thead className="bg-gray-50 text-gray-700 text-sm">
                <tr>
                  ...
                  <th className="px-4 py-3 font-medium">Numero Doc.</th>
                              ...
                              <DropdownMenuContent align="end">
                                ...
                                <AlertDialog>
                                  ...
                                  <AlertDialogContent>
                                    <AlertDialogHeader>
                                      <AlertDialogTitle>
                                        Eliminar Adelanto de sueldo
                                      </AlertDialogTitle>
                                      <AlertDialogDescription>
                                        Esta acción no se puede deshacer.
                                        ¿Deseas eliminar el adelanto de sueldo
                                        de{" "}
                                        <strong>
                                          {`${t.nombres ?? ""} ${
                                            t.apellidos ?? ""
              ...
              <section className="grid grid-cols-2 space-x-3">
                <div className="flex-1 flex flex-col gap-1">
                  ...
                  <Select
                    value={form.tipo}
                    onValueChange={(val) => {
                      if (val == "gratificacion" || val == "cts") {
                        setForm((prevForm) => ({
                          ...prevForm,
                          tipo: val,
                          forma_descuento: null,
                          primera_cuota: null,
                          cuotas: 1
                        }));
                      } else {
